  ...
  return (
    <div className="container_list_stores ">
      <div className="Container_bar1 ">
        <div className="Search_list1 flex appearance-none border-b  left-2 m-5 sm:max-w-screen-sm w-40 text-stone-900 ">
          <input type="text" className="appearance-none bg-transparent px-4 py-2 w-40" placeholder="Seleccionar Departamento"></input>
          <CaretDownOutlined />
        </div>
        <div className="Search_list1 flex appearance-none border-b  left-2 m-5 sm:max-w-screen-sm w-40 text-stone-900 ">
          <input type="text" className="appearance-none bg-transparent px-4 py-2 w-40" placeholder="Seleccionar ciudad"></input>
          <CaretDownOutlined />
        </div>
        <div className="Search_list1 flex appearance-none border-b  left-2 m-5 sm:max-w-screen-sm w-40 text-stone-900 ">
          <input type="text" className="appearance-none bg-transparent px-4 py-2 w-40" placeholder="Seleccionar zona"></input>
          <CaretDownOutlined />
        </div>
        <div className="Search_list1 flex appearance-none border-b  left-2 m-5 sm:max-w-screen-sm w-40 text-stone-900 ">
          <input type="text" className="appearance-none bg-transparent px-4 py-2 w-40" placeholder="Buscar tipo de sede"></input>
          <CaretDownOutlined />
        </div>
        <div className="Search_bar flex appearance-none   left-2 m-5 sm:max-w-screen-sm text-stone-900">
          ...
          <input type="text" className="appearance-none bg-transparent px-4 py-2 w-40" placeholder="Buscar sede"></input>
        </div>
